...
(function _ElodeMain_() {
    ...
    */
    ...
    /* 
        ELODE HOOK - procedure to include functions
    ...
    */
    function _hook_(target, include) {
        ...
        if (name[0] == "") {
            window.Elode.hook[name[1]](target, value);
        } else {
            eval("window.Elode.hook." + name[0] + "." + name[1] + "(target,value);");
        }
    }
