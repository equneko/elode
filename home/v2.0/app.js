...
render(
    div("#app.center",
        ...
        UniqueView = Content({
            ...
            div(".carbon",
                img("[src res/images/carbon1.svg|style width:700px]")
            ),
        ]),
        ...
        DeclarativeView = Content({
            ...
            div(".preview.flex[style padding:0em 2em]",
                div(".carbon",
                    img("[src res/images/carbon2.svg|style width:600px;transform: rotate(1deg)]")
                ),
        ...
        LightweightView = Content({
            ...
            div(".preview.flex[style padding:0em 2em]",
                ...
                div(".carbon",
                    img("[src res/images/carbon3.svg|style width:600px;transform: rotate(-1deg)]")
                ),
            )
        ]),
        ...
        ReactiveView = Content({
            ...
            div(".preview.flex[style padding:0em 2em]",
                ...
                div(".carbon",
                    img("[src res/images/carbon4.svg|style width:600px;transform: rotate(1deg)]")
                ),
                div(".center[style width:100%]",
        ...
        AlternativeView = Content({
            ...
            div(".preview.flex[style padding:0em 2em]",
                ...
                div(".carbon",
                    img("[src res/images/carbon5.svg|style width:600px;transform: rotate(-1deg)]")
                ),
            )
        ]),
