function NavBar(data) {
    return div(".nav.bg-white.shadow[style opacity:95%]",
        div(".bg-trans[style display:inline-flex]",
            ...
            link(".bg-trans.menu.dark[style margin:0.4em 0.03em;margin-left:-2.5em][:link https://equneko.github.io/elode] " + data.title),

            link(".search.bg-trans.menu.dark[style margin:0.3em 0.03em;margin-right:-1em][:searchClick] <span.fa.fa-search>"),
            link("#Search.bg-wheat[style margin:1em 0.5em 1.4em 0.5em;padding:0;width:15em][:searchClick]"),
...
function LetsGoo() {
    return div(".letsgoo.content[style margin:0em auto]",
        img("[src res/images/letsgoo.png| style width:400px]")
        , {
            letsgoo() {
                let self = this;
                self.show();
