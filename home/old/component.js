...
function Jumbotron(){
    return Elode([
        "#jumbotron.center[style margin-bottom:2em;width:70%].white",
        `h1.f2[style font-weight:700] 
            An <span.red.f2 Unique> Javascript Module <br>
            <span.f2.grey for Creating <span.blue.f2 HTML Element>>
        `,
        "p.f1 Creating, Composing and Rendering HTML Element in An Unique Way!"
    ]);
}

function PostCard(data){
    return Elode([
        ".postcard.container.inline"+data.addc,
