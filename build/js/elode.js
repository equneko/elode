...
====================================================================
    ...
    Elode.js (Source) - v2.0 (Release: 27-06-2023) 
    ...
    */
    ...
    window.Elode = function _ElodeModule_(query, property) {
        ...
        /* 
            ...
            @Example: 
                <div id="app">
                    h1.test hei im unique syntax
                    p.blue get started!
                </div>

                or with elode attribute directive

                <div id="withvalue" elode="
                    h1.test Hello World
                    p.blue get started!
                "></div>
        */
    ...
    window.Elode.map = function (root, array, callback, isArray) {
        ...
        function append(__array) {
            try {
                let i, map = eval("array.map(" + array.el + ")");
                if (__array != null) {
        ...
        array.push = (function () {
            let push = array.push;
            return function () {
                let i, fun = push.apply(this, arguments);
        ...
        array.pop = (function () {
            let pop = array.pop;
            return function () {
                let fun = pop.apply(this, arguments);
        ...
        array.shift = (function () {
            ...
            return function () {
                let fun = shift.apply(this, arguments);
        ...
        array.filter = (function () {
            ...
            return function () {
                let fun = filter.apply(this, arguments);
        ...
        let i, f = ["splice", "sort", "reverse"];
        for (i in f) {
            eval(
                "array." + f[i] + " = (function(){" +
                "   let " + f[i] + " = array." + f[i] + ";" +
                "   return function(){" +
                "       let fun = " + f[i] + ".apply(this,arguments);" +
                "       array.root().html(''); append();" +
                "       return fun;" +
                "   }" +
                "})();"
    ...
    */
    function _property_(element) {
        ...
        element.toggle = function (A, B) {
            ...
            if (A == "style" || A.includes("on")) ident = ";";
            ...
            if (B.constructor == Array) {
                ...
                if (attr.includes(B)) {
                    attr = attr.replace(ident + B, "");
                    element.attr(A, attr.trim());
                } else {
                    element.attr(A, (attr + ident + B).trim());
                }
    ...
    function query_search(source, target, callback, descriptor) {
        ...
        if (descriptor.next == null) {
            ...
            if (descriptor.split != null) {
                ...
                let T = t.split(descriptor.split);
...
(function _Elode_Hook_() {
    ...
    window.Elode.hook({
        ...
        attr(el, data) {
            el.__proto__.__data = data;
            let fun = el.onReact;
            el.onReact = function () {
                if (fun) fun();
                let i, k, v, data = getHookData(el, el.__proto__.__data);
                if (data == null) return;
        ...
        seen(el, data) {
            ...
            let fun = el.onReact;
            el.onReact = function () {
                if (fun) if (fun) fun(); el.seen(getHookData(el, el.__proto__.__data));
            }
        },
